        ...
        <div className="max-w-2xl mx-auto space-y-6">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Share your idea with the community. Be specific about what you did like to see. 
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <form action={action} className="space-y-6">
                        <div className="space-y-2">
                            ...
                            <Input id="title" name="title" placeholder="what whould you like to see ?" required/>
                        </div>
