    ...
    <div className="space-y-12">
      ...
      >
        <div className="flex gap-4 justify-center pt-4">
          <Button asChild size="lg" className="bg-white text-blue-600 hover:bg-grey-100">
            <Link href="/feedback/new">Submit Feedback <ArrowRight className="ml-2 h-4 w-4"/></Link>  
          </Button>

          <Button asChild size="lg" className="bg-white text-black-600 hover:bg-grey-100">
            <Link href="/feedback/new">View Roadmap <Map className="ml-2 h-4 w-4" /></Link>
          </Button>
        </div>
      </GradientHeader>
      ...
      <section>
        ...
        <div className="grid grid-cols-1 mf:grd-cols-2 lg:grid-cols-4 gap-4">
          <Card>
            <CardHeader>
            ...
            <CardContent>
              <p className="text-muted-foreground">Share your suggestions and feature request with the community.</p>
            </CardContent>
          </Card>
